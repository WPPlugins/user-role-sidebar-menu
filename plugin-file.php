...
* Description: Manage custom Sidebar menus based on logged-in user and you can assign different custom menus for different user roles on any WordPress page. 
* Version: 0.0.1
* Author: Achyuth401
